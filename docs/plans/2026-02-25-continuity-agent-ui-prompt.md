# Continuity Agent UI Prompt — Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Write a masterfully crafted generative prompt — structured in three layers (Soul, World, Proof) — that an AI code generator (Claude/GPT-4o) can receive and produce a visually stunning, self-contained single HTML file demonstrating the Continuity Agent voice-first interface.

**Architecture:** The prompt is a markdown document, not code. It uses a Layered Reveal structure: Layer 1 (Soul) emotionally primes the developer before any spec lands; Layer 2 (World) defines visual physics and the blur-to-clarity signature; Layer 3 (Proof) provides three choreographed interactive demo scenarios. The output of running this prompt in an AI code generator should be a working HTML/CSS/JS demo file.

**Tech Stack:** Markdown (prompt document), target output HTML/CSS/JS (single file, CDN-allowed for GSAP/anime.js), no build step required.

**Source Files:**
- `conversational-canvas-architecture.md` — zone system, animation specs, lifecycle rules, scenarios
- `Prompt-prompt.md` — original meta-request

**Output File:**
- `Continuity-Agent-UI-Prompt.md` (root level, copy-paste ready)

---

### Task 1: Write Layer 1 — The Soul Layer

**Files:**
- Create: `Continuity-Agent-UI-Prompt.md` (root of project)

**Step 1: Open the file and write the document header**
...
**Step 2: Write the Soul Layer (3 paragraphs)**

Write these three paragraphs exactly as follows — this is the complete Layer 1:
...
Read Layer 1 aloud. Ask: does it make you *feel* something before you've read a single spec? If yes, proceed. If not, revise paragraph 3 to end with more of a creative dare.

**Step 4: Commit placeholder**

```bash
git add Continuity-Agent-UI-Prompt.md
git commit -m "feat: begin ui prompt — Layer 1 Soul complete"
```

*(Skip if no git repo — this project currently has no git. Create the file and save.)*

---

### Task 2: Write Layer 2 — The World Layer

**Files:**
- Modify: `Continuity-Agent-UI-Prompt.md`

**Step 1: Add section header and color palette guidance**
...
**Step 2: Add the Signature Thinking Form spec**
...
**Step 3: Add Element Lifecycle spec**
...
**Step 5: Add Voice Priority and Animation Physics spec**
...
**Step 6: Verify Layer 2 completeness**

Check that these five things are present and clear:
- [ ] Color described in sensory terms (not hex)
- [ ] Thinking form described as feeling, not shape
- [ ] Blur-to-clarity named as THE signature transition
- [ ] Three zones defined with their behaviors
- [ ] Voice priority rule stated

**Step 7: Save the file**

---

### Task 3: Write Layer 3 — The Proof Layer (Scenario 1: Image)

**Files:**
- Modify: `Continuity-Agent-UI-Prompt.md`

**Step 1: Add the Proof Layer header and instructions for the developer**
...
### Task 4: Write Layer 3 — Scenario 2: Location Search

**Files:**
- Modify: `Continuity-Agent-UI-Prompt.md`

**Step 1: Write Scenario 2**
...
### Task 5: Write Layer 3 — Scenario 3: On-the-fly Note
...
### Task 6: Write Hard Constraints and Final Instructions

**Files:**
- Modify: `Continuity-Agent-UI-Prompt.md`

**Step 1: Add the Hard Constraints section**
...
**Step 2: Add the closing creative charge**
...
**Step 3: Verify the complete document**

Read through the full `Continuity-Agent-UI-Prompt.md` and confirm:
- [ ] Layer 1 makes you feel something before you've read a spec
- [ ] Layer 2 blur-to-clarity is named as the signature transition
- [ ] Layer 2 thinking form is evocative, not prescriptive
- [ ] Layer 2 color is sensory, not hex
- [ ] All 3 scenarios are specific enough to implement
- [ ] Scenarios reference blur-to-clarity for EVERY element entry
- [ ] Hard constraints are clear and complete
- [ ] Final note lands emotionally
...
**Files:**
- Read: `Continuity-Agent-UI-Prompt.md`
- Reference: `conversational-canvas-architecture.md`

**Step 1: Cross-reference against architecture doc**

Check the following are consistent between the prompt and the architecture:
- Zone names and behaviors (Transcendent / Conversation / Ephemeral)
- Element lifecycle terminology (Birth / Life / Death)
- Animation durations (300–500ms birth, 400–600ms death, 6s float)
- Voice priority behavior (dims to 30%, does not remove)
- Shelf behavior (30% opacity, 2-minute archive)

**Step 2: Read the prompt as the AI developer**

Mentally simulate: if you received this prompt cold, with no other context, would you know:
- What to build (yes: single HTML file demo)
- How it should feel (yes: warm, breathing, blur-to-clarity)
- What scenarios to implement (yes: 3 specific sequences)
- What you cannot do (yes: hard constraints)
- Why any of it matters (yes: the Soul Layer and final note)

**Step 3: Make any final edits, then save**

---

## Verification

Run the finished prompt through Claude or GPT-4o. The resulting HTML file should:

1. Open in a browser with no errors
2. Show a near-empty warm-toned canvas on load
3. Run Scenario 1 (image generation) with Zone 1 thinking form, blur-to-clarity image arrival, caption, and shelf save
4. Run Scenario 2 (map + pins) with staggered pin arrival and shelf cards
5. Run Scenario 3 (notepad + diagram) with notepad expand/collapse and diagram dimming
6. All animations loop without jank
7. No element "snaps" on or off — every transition is breath

If any of these fail, the prompt needs revision in the relevant section. Fix the Layer 2 spec (World) if animations are wrong. Fix the Proof Layer scenario if behavior is missing or incorrect.
